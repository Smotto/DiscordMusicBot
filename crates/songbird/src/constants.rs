...
/// Version 8 is required for ClientConnect (opcode 12) and ClientDisconnect (opcode 13) events,
/// which provide SSRC→user_id mapping for new users joining voice channels.
